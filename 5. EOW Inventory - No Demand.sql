...
CREATE TABLE [available_dev_no_dmnd]( 
  ...
  ,[pop_code]            VARCHAR(54)
  ,[current_oh]          FLOAT
  ,[eow_oh_wk1_no_dmnd]  FLOAT 
  ,[eow_oh_wk2_no_dmnd]  FLOAT
  ,[eow_oh_wk3_no_dmnd]  FLOAT
  ,[eow_oh_wk4_no_dmnd]  FLOAT
  )
  ;
...
,
  ...
  AS (
	...
	JOIN [available_dev]
	  ON [current_inventory].[short_partnumber] = [available_dev].[item_id]
    GROUP BY [current_inventory].[short_partnumber]
	  )
,
